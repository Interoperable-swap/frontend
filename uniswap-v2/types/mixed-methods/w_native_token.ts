...
import type * as ArgumentTypes from '../types-arguments/w_native_token';
import type * as ReturnTypes from '../types-returns/w_native_token';
...
export default class Methods {
	...
	*/
	"deposit" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "deposit", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "w_native_token");
		}, [], __options);
	}
	...
	*/
	"tokenSymbol" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenSymbol", [], __options, (result) => { return handleReturnType(result, getTypeDescription(16, 'w_native_token')); });
	}
	...
	*/
	"tokenName" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenName", [], __options, (result) => { return handleReturnType(result, getTypeDescription(16, 'w_native_token')); });
	}
