...
import type * as ArgumentTypes from '../types-arguments/SUSHI_token';
...
export default class Methods {
	...
	*/
	"transfer" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22::transfer", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "SUSHI_token");
	...
	*/
	"tokenSymbol" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenSymbol", [], __options, (result) => { return handleReturnType(result, getTypeDescription(16, 'SUSHI_token')); });
	}
	...
	*/
	"tokenName" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenName", [], __options, (result) => { return handleReturnType(result, getTypeDescription(16, 'SUSHI_token')); });
	}
