...
import type * as ArgumentTypes from '../types-arguments/UNI_token';
import type * as ReturnTypes from '../types-returns/UNI_token';
...
export default class Methods {
	...
	*/
	"increaseAllowance" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22::increaseAllowance", (events: EventRecord) => {
			return decodeEvents(events, this.__nativeContract, "UNI_token");
	...
	*/
	"tokenSymbol" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenSymbol", [], __options, (result) => { return handleReturnType(result, getTypeDescription(16, 'UNI_token')); });
	}
	...
	*/
	"tokenName" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenName", [], __options, (result) => { return handleReturnType(result, getTypeDescription(16, 'UNI_token')); });
	}
