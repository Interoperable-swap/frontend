...
export default class Methods {
	...
	*/
	"deposit" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "deposit", [], __options);
	}
	...
	*/
	"withdraw" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "withdraw", [amount], __options);
	}
