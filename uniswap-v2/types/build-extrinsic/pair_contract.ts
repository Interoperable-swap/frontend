...
export default class Methods {
	...
	*/
	"sync" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::sync", [], __options);
	}
	...
	*/
	"burn" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::burn", [to], __options);
	}
	...
	*/
	"getToken1" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::getToken1", [], __options);
	}
	...
	*/
	"price0CumulativeLast" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::price0CumulativeLast", [], __options);
	}
	...
	*/
	"getReserves" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::getReserves", [], __options);
	}
	...
	*/
	"getToken0" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::getToken0", [], __options);
	}
	...
	*/
	"price1CumulativeLast" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::price1CumulativeLast", [], __options);
	}
	...
	*/
	"skim" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::skim", [to], __options);
	}
	...
	*/
	"swap" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::swap", [amount0Out, amount1Out, to], __options);
	}
	...
	*/
	"mint" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::mint", [to], __options);
	}
	...
	*/
	"initialize" (
		...
		return buildSubmittableExtrinsic( this.__nativeContract, "pair::initialize", [token0, token1], __options);
	}
