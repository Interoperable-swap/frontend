...
export default class Methods {
	...
	*/
	"withdraw" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "wnative::withdraw", [amount], __options );
	}
	...
	*/
	"tokenSymbol" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenSymbol", [], __options , (result) => { return handleReturnType(result, getTypeDescription(16, 'wnative_contract')); });
	}
	...
	*/
	"tokenName" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "psp22Metadata::tokenName", [], __options , (result) => { return handleReturnType(result, getTypeDescription(16, 'wnative_contract')); });
	}
