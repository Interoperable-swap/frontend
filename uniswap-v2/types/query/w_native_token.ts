...
export default class Methods {
	...
	*/
	"deposit" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "deposit", [], __options );
	}
	...
	*/
	"withdraw" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "withdraw", [amount], __options );
	}
