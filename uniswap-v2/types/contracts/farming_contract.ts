...
import ABI from '../../artifacts/farming_contract.json';
import QueryMethods from '../query/farming_contract';
import BuildExtrinsicMethods from '../build-extrinsic/farming_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/farming_contract';
import MixedMethods from '../mixed-methods/farming_contract';
import EventsClass from '../events/farming_contract';
