...
import ABI from '../../artifacts/factory_contract.json';
import QueryMethods from '../query/factory_contract';
import BuildExtrinsicMethods from '../build-extrinsic/factory_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/factory_contract';
import MixedMethods from '../mixed-methods/factory_contract';
import EventsClass from '../events/factory_contract';
