...
import ABI from '../../artifacts/psp22_token.json';
import QueryMethods from '../query/psp22_token';
import BuildExtrinsicMethods from '../build-extrinsic/psp22_token';
import TxSignAndSendMethods from '../tx-sign-and-send/psp22_token';
import MixedMethods from '../mixed-methods/psp22_token';
import EventsClass from '../events/psp22_token';
