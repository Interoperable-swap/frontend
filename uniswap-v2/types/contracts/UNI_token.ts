...
import ABI from '../../artifacts/UNI_token.json';
import QueryMethods from '../query/UNI_token';
import BuildExtrinsicMethods from '../build-extrinsic/UNI_token';
import TxSignAndSendMethods from '../tx-sign-and-send/UNI_token';
import MixedMethods from '../mixed-methods/UNI_token';
import EventsClass from '../events/UNI_token';
