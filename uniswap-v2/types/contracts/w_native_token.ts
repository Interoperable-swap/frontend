...
import ABI from '../../artifacts/w_native_token.json';
import QueryMethods from '../query/w_native_token';
import BuildExtrinsicMethods from '../build-extrinsic/w_native_token';
import TxSignAndSendMethods from '../tx-sign-and-send/w_native_token';
import MixedMethods from '../mixed-methods/w_native_token';
import EventsClass from '../events/w_native_token';
