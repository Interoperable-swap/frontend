...
import ABI from '../../artifacts/SUSHI_token.json';
import QueryMethods from '../query/SUSHI_token';
import BuildExtrinsicMethods from '../build-extrinsic/SUSHI_token';
import TxSignAndSendMethods from '../tx-sign-and-send/SUSHI_token';
import MixedMethods from '../mixed-methods/SUSHI_token';
import EventsClass from '../events/SUSHI_token';
